<script type="text/javascript"> 
	function display(type, id, prefix) { 
		if (target = document.getElementById(prefix + id)) {
			...
			for(var i = 0; i <= 2271; i++)
				if (hideme = document.getElementById(prefix + i))
...
<div class='NavOuter'> 
	<div class='NavInner'> 
		<div class='FreeButton' style="color:606060;margin:3px">
			{L_INVENTORY}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=aas&char={FIRST_NAME}';" style="margin:3px">
			{L_AAS}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=keys&char={FIRST_NAME}';" style="margin:3px">
			{L_KEYS}
		</div>
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=flags&char={FIRST_NAME}';" style="margin:3px">
			{L_FLAGS}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=skills&char={FIRST_NAME}';" style="margin:3px">
			{L_SKILLS}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=corpse&char={FIRST_NAME}';" style="margin:3px">
			{L_CORPSE}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=factions&char={FIRST_NAME}';" style="margin:3px">
			{L_FACTION}
		</div> 
		<div class='FreeButton' onclick="window.location='{INDEX_URL}?page=charmove&char={FIRST_NAME}';" style="margin:3px">
			{L_CHARMOVE}
		</div> 
		<div class='FreeButton' onclick="window.external.AddFavorite(location.href, document.title);" style="margin:3px">
			{L_BOOKMARK}
		</div> 
	</div> 
</div> 
	...
	<table> 
		<tr> 
			...
			<td width='460px' align='center'> 
				<div class='InventoryOuter{HIGHLIGHT_GM}'> 
					<div class='InventoryTitle'> 
						<div class='InventoryTitleLeft'></div> 
						<div class='InventoryTitleMid'>
							{L_HEADER_INVENTORY}
						</div> 
					...
					<div class='InventoryStats'> 
						<table class='StatTable'> 
							...
							<tr>
								...
								<td width='100%'>
									<font color='#00FF00'>
										{STR} <font color='Gold'>+{HSTR}</font><br>
										{STA} <font color='Gold'>+{HSTA}</font><br>
										{AGI} <font color='Gold'>+{HAGI}</font><br>
										{DEX} <font color='Gold'>+{HDEX}</font>
									</font>
								</td>
							</tr> 
							<tr>
							...
							<tr> 
								...
								<td width='100%'>
									<font color='#00FF00'>
										{WIS} <font color='Gold'>+{HWIS}</font><br>
										{INT} <font color='Gold'>+{HINT}</font><br>
										{CHA} <font color='Gold'>+{HCHA}</font>
									</font>
								</td> 
							</tr> 
							<tr>
							...
							<tr> 
								...
								<td>
									<font color='#00FF00'>
										{POISON} <font color='Gold'>+{HPOISON}</font><br>
										{MAGIC} <font color='Gold'>+{HMAGIC}</font><br>
										{DISEASE} <font color='Gold'>+{HDISEASE}</font><br>
										{FIRE} <font color='Gold'>+{HFIRE}</font><br>
										{COLD} <font color='Gold'>+{HCOLD}</font><br>
										{CORRUPT} <font color='Gold'>+{HCORRUPT}</font>
									</font>
								</td>
							</tr>
							<tr>
					...
					<div class='Coin' style='top: 116px;left: 317px;'>
						<table class='StatTable'>
							<tr>
								<td align='left'>
									<img src='{ROOT_URL}images/pp.gif'>
								</td>
					...
					<div class='Coin' style='top: 144px;left: 317px;'>
						<table class='StatTable'>
							<tr>
								<td align='left'>
									<img src='{ROOT_URL}images/gp.gif'>
								</td>
								<td align='center' width='100%'>
									{GP}
								</td>
					...
					<div class='Coin' style='top: 172px;left: 317px;'>
						<table class='StatTable'>
							<tr>
								<td align='left'>
									<img src='{ROOT_URL}images/sp.gif'>
								</td>
								<td align='center' width='100%'>
									{SP}
								</td>
					...
					<div class='Coin' style='top: 200px;left: 317px;'>
						<table class='StatTable'>
							<tr>
								<td align='left'>
									<img src='{ROOT_URL}images/cp.gif'>
								</td>
								<td align='center' width='100%'>
									{CP}
								</td>
		...
		<tr> 
			<td colspan='3' align='center'><br><br><br> 
			<!-- BEGIN item --> 
					...
					<div class='ItemInner' style='text-align:left;'>        
						...
						<center> 
							...
							<table class='AugTable'> 
								<tr>
									<td align='center'>
										<a href='{item.augment.AUG_LINK}'>
											{item.augment.AUG_NAME}
										</a>
									</td>
								</tr> 
								<tr>
