<div class='WindowComplex PositionServer CB_Can_Drag'>
   ...
   <nav class='CB_Tab_Box'>
      <ul>
         <li id='tab1' onclick="CB_displayTab('#charbrowser NAV.CB_Tab_Box UL LI', '#tab1', '#charbrowser DIV.PositionServer DIV.CB_GuildTabBoxes', '#tabbox1');">{L_CLASSES}</li> 
         <li id='tab2' onclick="CB_displayTab('#charbrowser NAV.CB_Tab_Box UL LI', '#tab2', '#charbrowser DIV.PositionServer DIV.CB_GuildTabBoxes', '#tabbox2');populateChart();">{L_LEVELS}</li> 
      </ul>
   </nav>   
...
<script type="text/javascript">
   ...
   $( document ).ready(function() {
      CB_displayTab('#charbrowser NAV.CB_Tab_Box UL LI', '#tab1', '#charbrowser DIV.PositionServer DIV.CB_GuildTabBoxes', '#tabbox1');
   });
</script>
