<?php
	...
	***************************************************************************/
	...
	function GetMaxHP($mlevel, $class, $sta, $ihp) { 
        ...
        if ($mlevel < 41)
			$base_hp = (5 + ($mlevel * $hp_factor / 12) + (($sta - $Post255) * $level * $hp_factor / 3600)); 
        else if ($mlevel < 81) { 
			$base_hp = (5 + (40 * hp_factor / 12) + (($mlevel - 40) * $hp_factor / 6) + (($sta - $Post255) * $hp_factor / 90) + (($sta - $Post255) * ($mlevel - 40) * $hp_factor / 1800)); 
        } 
        else { 
			$base_hp = (5 + (80 * $hp_factor / 8) + (($mlevel - 80) * $hp_factor / 10) + (($sta - $Post255) * $hp_factor / 90) + (($sta - $Post255) * $hp_factor / 45)); 
        } 
        $base_hp += $ihp; 
